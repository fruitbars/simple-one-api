...
- **Llama Family**
   ...
   - **申请流程**：docs/Llama Family接入指南.md](llama_family接入指南.md)
- groq
   - **次数限制**：rpm为30，rpd为14400，TOKENS PER MINUTE也有限制
   - **文档地址**：https://console.groq.com/docs/text-chat
   - 申请流程：[docs/Llama Family接入指南.md](docs/groq接入指南.md）
